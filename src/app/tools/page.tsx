...
export default function ToolsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">Alle Tools</h1>

      {/* Search & Filter */}
      <div className="flex flex-col sm:flex-row gap-4 mb-8">
        <input
          type="text"
          placeholder="Tool-Namen, Suchbegriffe..."
          value={search}
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-16 text-gray-500">
          Keine passenden Tools gefunden. Versuche andere Suchbegriffe.
        </div>
      ) : (
