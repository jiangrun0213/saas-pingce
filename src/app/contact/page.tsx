...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">{t('page.contact')}</h1>
      <div className="space-y-8 text-gray-700 leading-relaxed">
        <p>Hast du Fragen, Anregungen oder möchtest du mit uns zusammenarbeiten? Wir antworten in der Regel innerhalb von 1–2 Werktagen.</p>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <a href="mailto:contact@saas-xuanxing.com" className="text-blue-600 hover:underline text-lg">contact@saas-xuanxing.com</a>
